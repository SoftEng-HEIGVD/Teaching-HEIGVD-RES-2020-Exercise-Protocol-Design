...
public class Server implements Runnable {
    ...
    public void run() {
        try {
            LOG.log(Level.INFO, "Starting Presence Server on port {0}", Protocol.CALC_DEFAULT_PORT);
    ...
    class Worker implements Runnable {
        ...
        public void run() {
            ...
            Server.this.notifyConnectedWorkers("  Say something to other users with 'SAY message'");
